...
public:
  ...
  ~marker() { backtrace_impl::remove_last_mark(); }
...
#define sona_mark_stack(desc)                                                  \
  sona::backtrace_impl::marker ___sona_builtin_marker_var(__FILE__, __LINE__,  \
                                                          __func__, desc);
#define sona_mark_stack1()                                                     \
  sona::backtrace_impl::marker __sona_builtin_marker_var(__FILE__, __LINE__,   \
                                                         __func__, "");
