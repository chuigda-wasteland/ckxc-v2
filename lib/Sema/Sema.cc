...
ref_ptr<AST::Type const>
SemaClass::ResolveBasicType(ref_ptr<Syntax::Type const> type) {
  (void)type;
...
ref_ptr<AST::Type const>
SemaClass::ResolveUserDefinedType(ref_ptr<Syntax::Type const> type) {
  (void)type;
  sona_unreachable1("not implemented");
  return nullptr;
}
...
ref_ptr<AST::Type const>
SemaClass::ResolveTemplatedType(ref_ptr<Syntax::Type const> type) {
  (void)type;
  sona_unreachable1("not implemented");
  return nullptr;
}
...
ref_ptr<AST::Type const>
SemaClass::ResolveComposedType(ref_ptr<Syntax::Type const> type) {
  (void)type;
  sona_unreachable1("not implemented");
  return nullptr;
}
